...
def do_git_update():
    ...
    if success:
        mesgdcrt.SuccessMessage("Adi_Bomb was updated to the latest version")
        mesgdcrt.GeneralMessage(
            "Please run the script again to load the latest version")
    else:
        mesgdcrt.FailureMessage("Unable to update Adi_Bomb.")
...
def check_for_updates():
    ...
    if fver != __VERSION__:
        ...
        mesgdcrt.SuccessMessage("Adi_Bomb is up-to-date")
        mesgdcrt.GeneralMessage("Starting AdiBomb")
...
def pretty_print(cc, target, success, failed):
    ...
    mesgdcrt.SuccessMessage("Adi_Bomb was created by Adi_Catechol")
...
description = """AdiBomb - Your Friendly Spammer Application

AdiBomb can be used for many purposes which incudes -
\t Exposing the vulnerable APIs over Internet
\t Friendly Spamming
\t Testing Your Spam Detector and more ....

AdiBomb is not intented for malicious uses.
"""
